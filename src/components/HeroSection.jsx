...
const HeroSection = () => (
  <div className="relative">
    ...
    {/* Fade overlay: top (opaque) to bottom (transparent) */}
    <div className="absolute inset-0 bg-gradient-to-b from-white/0 via-white/20 to-white/100"></div>
    ...
    <div className="relative py-24">
      <div className="max-w-6xl mx-auto px-4 text-center">
        ...
        >
          <h1 className="text-6xl md:text-7xl font-bold text-gray-900 mb-6 mt-5">
